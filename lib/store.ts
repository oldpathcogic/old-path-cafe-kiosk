...
const seedItems:MenuItem[] = [
  ...
  {id:"latte",name:"Latte",category:"Coffee",description:"Hot or iced, creamy and rich",imageUrl:"/menu-images/latte.webp",priceCents:600,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:3,allowedAddons:["vanilla","caramel","hazelnut","mocha","oat-milk","almond-milk","extra-shot","whipped-cream","decaf-espresso"],options:["Hot","Iced"],showOnKiosk:true,showOnMenuBoard:true},
