...
const seedItems:MenuItem[] = [
  {id:"regular-coffee",name:"Regular Coffee",category:"Coffee",description:"Classic drip coffee, hot and fresh",imageUrl:"/menu-images/regular-coffee.webp",priceCents:400,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:1,allowedAddons:["vanilla","caramel","hazelnut","mocha","dairy-milk","oat-milk","almond-milk","honey","sugar"],options:["Regular","Decaf"],showOnKiosk:true,showOnMenuBoard:true},
  {id:"cold-brew",name:"Cold Brew",category:"Coffee",description:"Smooth, bold, and refreshing",imageUrl:"/menu-images/cold-brew.webp",priceCents:600,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"Limited Edition",featured:true,displayOrder:2,allowedAddons:["vanilla","caramel","hazelnut","mocha","dairy-milk","oat-milk","almond-milk","honey","sugar"],options:[],showOnKiosk:true,showOnMenuBoard:true},
  {id:"latte",name:"Latte",category:"Coffee",description:"Hot or iced, creamy and rich",imageUrl:"/menu-images/latte.webp",priceCents:600,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:3,allowedAddons:["vanilla","caramel","hazelnut","mocha","dairy-milk","oat-milk","almond-milk","extra-shot","cold-foam","decaf-espresso","honey","sugar"],options:["Hot","Iced"],showOnKiosk:true,showOnMenuBoard:true},
  {id:"cappuccino",name:"Cappuccino",category:"Coffee",description:"Foamy, smooth, and full of flavor",imageUrl:"/menu-images/cappuccino.webp",priceCents:600,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:4,allowedAddons:["vanilla","caramel","hazelnut","mocha","dairy-milk","oat-milk","almond-milk","extra-shot","decaf-espresso","honey","sugar"],options:[],showOnKiosk:true,showOnMenuBoard:true},
  {id:"espresso-shot",name:"Espresso Shot",category:"Coffee",description:"Strong and rich",imageUrl:"/menu-images/espresso-shot.webp",priceCents:250,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:5,allowedAddons:["dairy-milk","decaf-espresso","honey","sugar"],options:[],showOnKiosk:true,showOnMenuBoard:true},
  {id:"tea",name:"Tea",category:"Coffee",description:"Freshly brewed, hot or iced",imageUrl:"/menu-images/tea.webp",priceCents:400,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:6,allowedAddons:["vanilla","caramel","hazelnut","dairy-milk","oat-milk","almond-milk","cold-foam","honey","sugar"],options:["Hot","Iced"],showOnKiosk:true,showOnMenuBoard:true},
  {id:"hot-chocolate",name:"Hot Chocolate",category:"Coffee",description:"Rich, warm, and chocolatey",imageUrl:"/menu-images/hot-chocolate.webp",priceCents:400,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,statusLabel:"",featured:false,displayOrder:7,allowedAddons:["vanilla","caramel","hazelnut","dairy-milk","oat-milk","almond-milk","cold-foam","extra-shot","honey","sugar"],options:[],showOnKiosk:true,showOnMenuBoard:true},
...
const seedAddons:Addon[] = [
  {id:"vanilla",name:"Vanilla Syrup",shortName:"Vanilla",category:"Flavor",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:1},{id:"caramel",name:"Caramel Syrup",shortName:"Caramel",category:"Flavor",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:2},{id:"hazelnut",name:"Hazelnut Syrup",shortName:"Hazelnut",category:"Flavor",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:3},{id:"mocha",name:"Mocha Syrup",shortName:"Mocha",category:"Flavor",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:4},{id:"dairy-milk",name:"Dairy Milk",shortName:"Dairy Milk",category:"Milk",priceCents:0,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:5},{id:"oat-milk",name:"Oat Milk",shortName:"Oat Milk",category:"Milk",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:6},{id:"almond-milk",name:"Almond Milk",shortName:"Almond Milk",category:"Milk",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:7},{id:"cold-foam",name:"Cold Foam",shortName:"Cold Foam",category:"Topping",priceCents:75,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:8},{id:"honey",name:"Honey",shortName:"Honey",category:"Sweetener",priceCents:0,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:9},{id:"sugar",name:"Sugar",shortName:"Sugar",category:"Sweetener",priceCents:0,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:10},{id:"extra-shot",name:"Extra Espresso Shot",shortName:"Extra Shot",category:"Coffee",priceCents:100,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:11},{id:"decaf-espresso",name:"Decaf Espresso Option",shortName:"Decaf",category:"Coffee",priceCents:50,available:true,manualAvailable:true,trackInventory:false,stockOnHand:0,lowStockThreshold:2,displayOrder:12},
];
const settingDefaults:Record<string,string> = {cafeName:"Sacred Grounds",subtitle:"Coffee. Connection. Community.",footer:"All proceeds support the ministry",paymentEnabled:"false",paymentProvider:"none",itemSheetUrl:"",addonSheetUrl:"",ordersLedgerUrl:""};
...
export async function seedDatabase(){
  ...
  const optionsVersion=await database.prepare("SELECT value FROM settings WHERE key='catalogOptionsVersion'").first<{value:string}>();
  if(optionsVersion?.value!=="2"){
    const newAddons=seedAddons.filter(addon=>["dairy-milk","honey","sugar"].includes(addon.id));
    const drinkItems=seedItems.filter(item=>item.category==="Coffee");
    await database.batch([
      ...newAddons.map(addon=>database.prepare("INSERT OR IGNORE INTO addons (id,name,short_name,category,price_cents,available,display_order,updated_at) VALUES (?,?,?,?,?,?,?,?)").bind(addon.id,addon.name,addon.shortName,addon.category,addon.priceCents,addon.available?1:0,addon.displayOrder,new Date().toISOString())),
      ...drinkItems.map(item=>database.prepare("UPDATE menu_items SET allowed_addons=?,updated_at=? WHERE id=?").bind(JSON.stringify(item.allowedAddons),new Date().toISOString(),item.id)),
      database.prepare("INSERT INTO settings (key,value,updated_at) VALUES ('catalogOptionsVersion','2',?) ON CONFLICT(key) DO UPDATE SET value='2',updated_at=excluded.updated_at").bind(new Date().toISOString()),
    ]);
  }
  await database.prepare("UPDATE settings SET value='Sacred Grounds',updated_at=? WHERE key='cafeName' AND value IN ('She Brews','Old Path Cafe')").bind(new Date().toISOString()).run();
}
