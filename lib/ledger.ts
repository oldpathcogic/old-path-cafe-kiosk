...
export async function buildLedgerCsv(kind:LedgerFormat){
  ...
  return {content:csv(["Order ID","Order Date","Order Time","Customer Name","Pickup Code","Status","Item Count","Subtotal","Tax","Total","Payment Status","Payment Provider","Source","Notes"],rows),filename:"old-path-cafe-orders.csv"};
}
